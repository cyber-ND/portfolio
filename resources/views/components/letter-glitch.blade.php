...
<div class="relative w-full min-h-screen bg-black overflow-hidden">
    ...
    @if ($centerVignette)
        <div class="absolute inset-0 w-full h-full pointer-events-none bg-[radial-gradient(circle,rgba(0,0,0,0.8)_0%,rgba(0,0,0,0)_60%)]"></div>
    @endif
    @if ($outerVignette)
        <div class="absolute inset-0 w-full h-full pointer-events-none bg-[radial-gradient(circle,rgba(0,0,0,0)_60%,rgba(0,0,0,1)_100%)]"></div>
    @endif
</div>
